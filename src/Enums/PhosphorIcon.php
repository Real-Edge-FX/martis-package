...
/**
 * All Phosphor Icons available in @phosphor-icons/react v2.
 * Values are the kebab-case icon names accepted by the ResourceIcon component.
 *
 * Usage in a Resource:
 *   public function icon(): string { return PhosphorIcon::Database->value; }
 *
 * Usage in a BelongsTo field:
 *   BelongsTo::make('author')
 *       ->resourceIcon(PhosphorIcon::User)
 *       ->createButtonIcon(PhosphorIcon::Plus);
 */
enum PhosphorIcon: string
{
    ...
    /**
     * Return a human-readable label for this icon (PascalCase with spaces).
     */
    public function label(): string
    {
        $parts = preg_split('/(?<=[a-z])(?=[A-Z])|(?<=[A-Z])(?=[A-Z][a-z])/', $this->name);

        return implode(' ', $parts !== false ? $parts : [$this->name]);
    }
}
