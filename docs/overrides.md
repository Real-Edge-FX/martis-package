...
The override system lets you replace any Martis React component, layout or server-side behaviour from your application. **Everything can be customized without forking**, and it is a core Martis differential.
