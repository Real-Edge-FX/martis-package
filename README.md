...
- **Comprehensive theme system** — 162 CSS variables across 19 groups (colors, typography, radius, shadows, charts, avatars, brand, file icons, density, motion, print). Dark + light modes. Generated by `martis:theme` with all variables documented.
...
- **Test coverage** — 4030 Pest + 1109 Vitest = **5139 passing**, 0 failing
...
| [Theming Guide](docs/theming.md) | Complete reference for all 162 CSS variables (colors, typography, radius, shadows, charts, density, motion) |
